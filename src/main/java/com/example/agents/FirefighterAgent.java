...
public class FirefighterAgent extends Agent {
  ...
  private String RESPONSE = "I am a firefighter, I'm gonna put out the fire!";
  private String SERVICE_DESCRIPTION = "Extinguish the fire";
    ...
    addBehaviour(new CyclicBehaviour(this) {
      public void action() {
        ...
        if (msg != null && msg.getContent().equalsIgnoreCase(serviceType)) {
          ...
          loggerUtils.prettyLog("The agent " + msg.getSender().getName() + " reported a fire ");
          loggerUtils.prettyLog("I will activate the procedures to combat the fire!");
